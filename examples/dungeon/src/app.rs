// ==============================================================================================
// Purpose:         Mini first person dungeon game
...
pub fn new(eng: &mut Engine) -> MyApp {
  ...
  let floor = eng.load_obj("assets/obj/dungeon/floor_tile_large.obj", false).expect("obj loading failed");
  let grate = eng.load_obj("assets/obj/dungeon/floor_tile_big_grate.obj", false).expect("obj loading failed");
  let floor_rocks = eng.load_obj("assets/obj/dungeon/floor_tile_large_rocks.obj", false).expect("obj loading failed");

  let wall = eng.load_obj("assets/obj/dungeon/wall.obj", false).expect("obj loading failed");

  let barrel_lg = eng.load_obj("assets/obj/dungeon/barrel_large.obj", false).expect("obj loading failed");
  let trunk = eng.load_obj("assets/obj/dungeon/trunk_large_C.obj", false).expect("obj loading failed");
  let boxobj = eng.load_obj("assets/obj/dungeon/box_small_decorated.obj", false).expect("obj loading failed");
