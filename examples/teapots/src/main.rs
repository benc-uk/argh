...
use argh::colour::*;
use argh::engine::{Engine, Key, Scene};
...
fn main() {
  let mut e = Engine::new(600, 360, "Argh: teapots", 2);
  e.debug = true;
  e.target_fps = 0;
  ...
  let crate_tex = ImageTexture::new("assets/crate.png").unwrap();
