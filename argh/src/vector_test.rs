...
#[test]
fn test_add_new() {
  let result = Vec2::new(1.0, 2.0).add_new(Vec2::new(3.0, 4.0));
...
fn test_add_new_with_zeros() {
  let result = Vec2::zero().add_new(Vec2::zero());
...
fn test_sub_self_gives_zero() {
  ...
  a.sub(Vec2::new(3.0, 7.0));
  assert_eq!(a, Vec2 { x: 0.0, y: 0.0 });
}

// --- sub_new (non-mutating) ---

#[test]
fn test_sub_new() {
  let result = Vec2::new(5.0, 7.0).sub_new(Vec2::new(2.0, 3.0));
  assert_eq!(result, Vec2 { x: 3.0, y: 4.0 });
}

#[test]
fn test_sub_new_with_negatives() {
  let result = Vec2::new(-1.0, -2.0).sub_new(Vec2::new(-4.0, -6.0));
  assert_eq!(result, Vec2 { x: 3.0, y: 4.0 });
}

#[test]
fn test_sub_new_self_gives_zero() {
  let result = Vec2::new(3.0, 7.0).sub_new(Vec2::new(3.0, 7.0));
...
fn test_mult_new() {
  let mut v = Vec2::new(2.0, 3.0);
  let result = v.mult_new(Vec2::new(4.0, 5.0));
...
fn test_mult_new_by_zero() {
  let mut v = Vec2::new(5.0, 7.0);
  let result = v.mult_new(Vec2::zero());
  assert_eq!(result, Vec2::zero());
}
...
fn test_mult_new_with_negatives() {
  let mut v = Vec2::new(-3.0, 2.0);
  let result = v.mult_new(Vec2::new(2.0, -3.0));
...
// --- div_new (non-mutating) ---

#[test]
fn test_div_new() {
  let mut v = Vec2::new(12.0, 20.0);
  let result = v.div_new(Vec2::new(3.0, 4.0));
  assert_eq!(result, Vec2::new(4.0, 5.0));
}

#[test]
fn test_div_new_by_self_gives_ident() {
  let mut v = Vec2::new(5.0, 9.0);
  let result = v.div_new(Vec2::new(5.0, 9.0));
...
fn test_div_new_with_negatives() {
  ...
  let result = v.div_new(Vec2::new(4.0, -3.0));
